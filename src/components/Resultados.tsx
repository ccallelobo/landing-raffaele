...
export default function Resultados({ data }: Props) {
  ...
  const fallback = [
    {
      id: 1,
      tratamiento: t("fallback.rinoplastia.treatment"),
      descripcion: t("fallback.rinoplastia.description"),
      before:
        "https://images.unsplash.com/photo-1504439904031-93ded9f93e4e?w=800&h=1000&fit=crop&crop=face",
      after:
        "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=800&h=1000&fit=crop&crop=face",
    },
    {
      id: 2,
      tratamiento: t("fallback.acidoHialuronico.treatment"),
      descripcion: t("fallback.acidoHialuronico.description"),
      before:
        "https://images.unsplash.com/photo-1509967419530-da38b4704bc6?w=800&h=600&fit=crop&crop=face",
      after:
        "https://images.unsplash.com/photo-1519125323398-675f0ddb6308?w=800&h=600&fit=crop&crop=face",
    },
    {
      id: 3,
      tratamiento: t("fallback.liftingFacial.treatment"),
    ...
    {
      id: 4,
      tratamiento: t("fallback.blefaroplastia.treatment"),
      ...
      after:
        "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=800&h=600&fit=crop&crop=face",
    },
  ];
  ...
  return (
    <section
      id="resultados"
      className="py-28 md:py-40 bg-noir text-white overflow-hidden"
    >
          ...
          {resultados.map((r, i) => (
            ...
            >
              <BeforeAfterSlider
                ...
                afterImage={r.after}
                beforeAlt={`${r.tratamiento} - ${t("before")}`}
                afterAlt={`${r.tratamiento} - ${t("after")}`}
              />
